...
"""
Reads an MSESIM output file in each output section. 

Channel = Channel names, ID numbers
Central Points = Contains mostly co-ordinate related values, can be inferred from object names below.
Grid Points = Parameters associated with beam emission
Resolution = EFIT derived parameters
Spectral Data = Wavelength vector and stokes components

Note: need to execute the restoration of the .dat file containing the data, as shown in the example below:
